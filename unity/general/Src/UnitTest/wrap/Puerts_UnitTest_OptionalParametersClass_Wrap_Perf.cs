...
{
    public static class Puerts_UnitTest_OptionalParametersClass_Wrap_Perf 
    {
    ...
    // ==================== methods start ====================
        ...
        private static void M_Test(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
...

                {
                    ...
                    //{
                    //    IntPtr v8Value01 = PuertsDLL.GetArgumentValue(info, 0);
                    //    object argobj01 = null;
                    //    //JsValueType argType0 = JsValueType.Invalid;
                    //    JsValueType argType01 = PuertsDLL.GetArgumentType(isolate, info, 0, false);

                    //    IntPtr v8Value11 = PuertsDLL.GetArgumentValue(info, 1);
                    //    object argobj11 = null;
                    //    //JsValueType argType1 = JsValueType.Invalid;
                    //    JsValueType argType11 = PuertsDLL.GetArgumentType(isolate, info, 1, false);

                    //    IntPtr v8Value21 = PuertsDLL.GetArgumentValue(info, 2);
                    //    object argobj21 = null;
                    //    //JsValueType argType2 = JsValueType.Invalid;
                    //    JsValueType argType21 = PuertsDLL.GetArgumentType(isolate, info, 2, false);
                    //}
                    //sw.Stop();
        ...
        private static JsValueType[] jsValueTypes = new JsValueType[3];
        private static IntPtr[] valuePtrs = new IntPtr[3];
        //private static MParam[] mParams = new MParam[3];
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_Test_S(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puerts.UnitTest.OptionalParametersClass;
...

                {
                    ...
                    //int size = Marshal.SizeOf(typeof(MParam)) * paramLen;

                    //IntPtr pBuff = Marshal.AllocHGlobal(size);
                    //Type type = typeof(MParam);
                    //var mparamSize = Marshal.SizeOf(type);
                    //var pBuffIntPtrSize = pBuff.ToInt64();
                    //JsValueType[] jsValueTypes = new JsValueType[paramLen];
                    //IntPtr[] valuePtrs = new IntPtr[paramLen];
                    //Stopwatch sw = new Stopwatch();
                    //sw.Start();
                    //for (var i = 0; i < 100000; i++)
                    //{

                    //    PuertsDLL.GetArgumentValue2(isolate, info, jsValueTypes, valuePtrs, paramLen);
                    ...
                    IntPtr v8Value0 = valuePtrs[0];
                    object argobj0 = null;
                    JsValueType argType0 = jsValueTypes[0];

                    IntPtr v8Value1 = valuePtrs[1];
                    object argobj1 = null;
                    JsValueType argType1 = jsValueTypes[1];

                    IntPtr v8Value2 = valuePtrs[2];
                    object argobj2 = null;
                    JsValueType argType2 = jsValueTypes[2];

                    if (argType0 == Puerts.JsValueType.Number && argType1 == Puerts.JsValueType.Number && argType2 == Puerts.JsValueType.Number)
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {   
                    ...
                    { new Puerts.MethodKey { Name = "Test_S", IsStatic = false}, M_Test_S },
